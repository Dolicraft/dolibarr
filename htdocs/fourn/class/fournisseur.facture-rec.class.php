	...
	*/
	...
	public function fetch($rowid)
	{
		...
		if ($result) {
			...
			$this->date_start               = $objp->date_start; // Not a SQL datetime string, but a boolean 0 or 1, jdate() would corrupt it
			$this->date_end                 = $objp->date_end; // Not a SQL datetime string, but a boolean 0 or 1, jdate() would corrupt it
